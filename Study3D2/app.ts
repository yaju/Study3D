...
class Study3DApp {
    ...
    private phi = 0.65;       		// x軸周りの回転角
    private theta = 6.90;    		// y軸周りの回転角
    private isDrag: boolean = false;
    private isWireFrame: HTMLInputElement;
    private isFill: HTMLInputElement;
    private isCulling: HTMLInputElement;
    ...
    constructor(canvas: HTMLCanvasElement) {
        ...
        this.isWireFrame = <HTMLInputElement>document.getElementById('wireFrameCheck');
        this.isFill = <HTMLInputElement>document.getElementById('fillCheck');
        this.isCulling = <HTMLInputElement>document.getElementById('cullingCheck');
        ...
        // 各チェックボックス変更
        this.isWireFrame.addEventListener("change", () => { this.drawModel(); });
        this.isFill.addEventListener("change", () => { this.drawModel(); });
        this.isCulling.addEventListener("change", () => { this.drawModel(); });
