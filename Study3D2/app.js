...
var Study3DApp = (function () {
    function Study3DApp(canvas) {
        ...
        this.isWireFrame = document.getElementById('wireFrameCheck');
        this.isFill = document.getElementById('fillCheck');
        this.isCulling = document.getElementById('cullingCheck');
        ...
        // 各チェックボックス変更
        this.isWireFrame.addEventListener("change", function () {
            _this.drawModel();
        });
        this.isFill.addEventListener("change", function () {
            _this.drawModel();
        });
        this.isCulling.addEventListener("change", function () {
            _this.drawModel();
        });
